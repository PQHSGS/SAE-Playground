...
class SkipTranscoder(BaseTranscoder):
    ...
    def __init__(
        ...
        **kwargs
        ...
        d_out = d_out or d_in
        super().__init__(d_in=d_in, d_sae=d_sae, d_out=d_out, k=k, aux_loss_coeff=aux_loss_coeff, freeze_skip=freeze_skip, **kwargs)
        self.k = k
    ...
    def forward(
        ...
        **kwargs
        ...
        return DictionaryOutput(
            ...
            loss=total_loss,
            loss_dict=loss_dict,
            extra_dict={"l0": float(self.k), "skip_out": skip_out, "pre_acts": pre_acts}
        )
